...
subprocess.check_output(["curl", "https://172.25.0.1:1000/", "-d" , f"4Tredir=https%3A%2F%2F172.25.0.1%3A1000%2Flogin%3F&magic={magic}&username={username}&password={password}", "-k"])
